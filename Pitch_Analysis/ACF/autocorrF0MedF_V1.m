%**************************************************************************
%   *********************autocorrF0MedF_V1*********************************
%   Recieved from VKM Sir(The first set of codes)
%   Being updated for getting F0 values
%   Update 1:   19-10-2016, Adding the lines to compute F0
%**************************************************************************
function [f0, xaxis, t0]= autocorrF0MedF_V1(x,fs,fsize,fshift,plotFlag)
