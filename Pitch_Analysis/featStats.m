...
% --------------------------------------------------------------------------
% --------------------------------------------------------------------------
function [cryMeanSSE, cryDevSSE, caseMeanSSE, caseDevSSE, cryTotMeanSSE, cryAvgDevSSE, sseFeatUp, begP, endP] = featStats(cryFile, featFile)
% close all; clc; clear all;
% Voice_Sample_Exp4_183 ms

% Feature Data Excel Files Path
xlSSEFeatPath = 'D:\Shivam\Research_IIITS\Experiments\Data\Cry Feature Data\Raw_Features_SrcPython\SSE\Pain\';
